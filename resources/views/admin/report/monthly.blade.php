...
@section('usercontent')
	<div id="page-head">
		<div id="page-title">
			<h1 class="page-header text-overflow"> Report / Monthly Type </h1>
		</div>
		<ol class="breadcrumb">
	...
	<div id="page-content">
        ...
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">All the Monthly Type</h3>
            </div>
                ...
                <table id="demo-dt-basic" class="table table-striped table-hover table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>@php if($payment->pay_type==1) {echo('<span class="label label-success"> Monthly  </span>');}else echo('<span class="label label-danger"> Weekly  </span>'); @endphp</td>
