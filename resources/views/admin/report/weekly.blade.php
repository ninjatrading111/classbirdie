...
@section('usercontent')
	<div id="page-head">
		<div id="page-title">
			<h1 class="page-header text-overflow"> Report / Weekly Type </h1>
		</div>
		<ol class="breadcrumb">
	...
	<div id="page-content">
        ...
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">All the Weekly Type</h3>
            </div>
                ...
                <table id="demo-dt-basic" class="table table-striped table-hover table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>@php if($payment->pay_type==0) {echo('<span class="label label-primary"> Weekly </span>');}else echo('<span class="label label-danger">  Monthly </span>'); @endphp</td>
